...
#####################################################################################################
# Full path of blast+ database. [e.g.] blast_db=/Users/username/ncbi-blast-2.11.0+/database/swissprot
blast_db=
...
directory_output=$1"_output_dir"

# Check whether the output directory exists. 
if [ -e ./$directory_output ]; then
	echo "The directory '"$directory_output"' for output data already exists."
	echo "Continue to run anyway ? (y/n) : "
	read cmd
	if [ $cmd = "y" ]; then
